...
export function Register() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try { await register(email, password, name); navigate('/welcome'); }
        ...
        <div className="relative z-10 grid grid-cols-3 gap-3 p-8 rotate-6 scale-110">
          {Array.from({ length: 9 }).map((_, i) => (
            <div key={i} className={`w-28 aspect-[2/3] rounded-xl border border-white/10 bg-gradient-to-b ${
              ['from-pink-900','from-indigo-900','from-teal-900','from-purple-900','from-blue-900','from-red-900','from-green-900','from-yellow-900','from-orange-900'][i]
      ...
      <div className="flex-1 flex items-center justify-center px-6 relative">
        ...
        <div className="relative z-10 w-full max-w-md">
          ...
          <div className="bg-gray-900/80 backdrop-blur border border-gray-800 rounded-2xl p-8">
            ...
            <p className="text-gray-500 text-sm mb-6">Empieza a gestionar tu lista de películas</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="block text-sm text-gray-400 mb-1.5" htmlFor="name">Nombre</label>
