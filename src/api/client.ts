import type { Movie, CreateMovieInput, UpdateMovieInput, ApiResponse, User, TmdbSearchResponse, Genre } from '../types';
...
export function tmdbGenreToLocal(genreIds: number[]): Genre {
